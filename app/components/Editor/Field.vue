...
<template>
  ...
  <EditorFieldTextArea v-else-if="field.type === 'textarea'" v-model="value" :title="formattedTitle" :placeholder="placeholder" :original="field.original" :allowed-characters="field.allowedCharacterTypes" />
