export const countries = [
  ...
  // IPTC-NAA Country Codes
  // Source: https://www.iptc.org/std/IIM/4.2/specification/IIMV4.2.pdf (Appendix D)
  { label: 'United Nations', value: 'XUN' },
  { label: 'European Union', value: 'XEU' },
  { label: 'Space', value: 'XSP' },
  { label: 'At Sea', value: 'XSE' },
  { label: 'In Flight', value: 'XIF' },
  { label: 'England', value: 'XEN' },
  { label: 'Scotland', value: 'XSC' },
  { label: 'Northern Ireland', value: 'XNI' },
  { label: 'Wales.', value: 'XWA' },
  { label: 'Palestine', value: 'PSE' },
  { label: 'Gaza', value: 'GZA' },
  { label: 'Jericho', value: 'JRO' },
]
